                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form role="form" action="{{ route('dept_office.student.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary float-md-right">Add Student</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
